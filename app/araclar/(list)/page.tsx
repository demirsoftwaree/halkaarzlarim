...
const araclar = [
  { icon: TrendingUp, baslik: "Tavan Simülatörü", aciklama: "Halka arzda kaç tavan giderse kaç ₺ kazanırsın?", href: "/araclar/tavan-simulatoru", renk: "text-emerald-400", bg: "bg-emerald-500/10", border: "hover:border-emerald-500/30" },
  ...
  { icon: Crown, baslik: "Tavan Getiri Raporu", aciklama: "10 günlük tavan senaryosu — PDF olarak indir.", href: "/araclar/tavan-raporu", renk: "text-yellow-400", bg: "bg-yellow-500/10", border: "hover:border-yellow-500/30" },
];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {araclar.map(({ icon: Icon, baslik, aciklama, href, renk, bg, border }) => (
